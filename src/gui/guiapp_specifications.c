...
/*  Date (dd.mm.yyyy):  7. 8.2019   Time (hh:mm): 00:50                        */
/*******************************************************************************/
...
GX_TEXT_BUTTON_PROPERTIES window2_BTN_DEC_properties =
{
...
GX_TEXT_BUTTON_PROPERTIES window2_BTN_INC_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window2_BTN_INC_define =
{
    "BTN_INC",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {179, 69, 218, 108},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_BTN_INC), /* control block         */
    (void *) &window2_BTN_INC_properties     /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window2_BTN_DEC_define =
{
    "BTN_DEC",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    BTN_DEC,                                 /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {39, 69, 78, 108},                       /* widget size                    */
    &window2_BTN_INC_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_BTN_DEC), /* control block         */
    (void *) &window2_BTN_DEC_properties     /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window2_BTN_START_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {152, 113, 251, 167},                    /* widget size                    */
    &window2_BTN_DEC_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_BTN_START), /* control block       */
    (void *) &window2_BTN_START_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window2_BTN_STOP_define =
{
    "BTN_STOP",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    BTN_STOP,                                /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {15, 114, 114, 168},                     /* widget size                    */
    &window2_BTN_START_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_BTN_STOP), /* control block        */
    (void *) &window2_BTN_STOP_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window2_BTN_ABOUT_define =
{
    "BTN_ABOUT",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {17, 87, 56, 126},                       /* widget size                    */
    &window2_BTN_STOP_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_BTN_ABOUT), /* control block       */
    (void *) &window2_BTN_ABOUT_properties   /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window2_PR_INFO_DEV_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {2, 7, 256, 171},                        /* widget size                    */
    &window2_text_view_define,               /* next widget definition         */
    &window2_BTN_ABOUT_define,               /* child widget definition        */
...
{
    GX_PIXELMAP_ID_WELCOME                   /* wallpaper pixelmap id          */
};
